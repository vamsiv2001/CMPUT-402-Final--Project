...
import tartan.smarthome.views.ExperimentView;
...
public class TartanResource {
    ...
    /**
     * Fetch the experiment report via HTTP GET. Managed by Jersey
     * @param house the house
     * @param user the user allowed to access this house
     * @return a view of the house or null
     */
    ...
    @Timed
    @UnitOfWork
    public ExperimentView experiment() {
        Map<String, Integer> doorCloseAnalytics = ReportVariationExperiment.getDoorCloseAnalytics();
        Map<String, Integer> intruderIncidenceAnalytics = ReportVariationExperiment.getIntruderIncidenceAnalytics();
        int barGraphHeightScalar = 40;
        return new ExperimentView(
            String.valueOf(doorCloseAnalytics.get("reportType1") * barGraphHeightScalar),
            String.valueOf(doorCloseAnalytics.get("reportType2") * barGraphHeightScalar),
            String.valueOf(doorCloseAnalytics.get("reportType3") * barGraphHeightScalar),
            String.valueOf(doorCloseAnalytics.get("reportType4") * barGraphHeightScalar),
            String.valueOf(intruderIncidenceAnalytics.get("reportType1") * barGraphHeightScalar),
            String.valueOf(intruderIncidenceAnalytics.get("reportType2") * barGraphHeightScalar),
            String.valueOf(intruderIncidenceAnalytics.get("reportType3") * barGraphHeightScalar),
            String.valueOf(intruderIncidenceAnalytics.get("reportType4") * barGraphHeightScalar)
        );
    }
